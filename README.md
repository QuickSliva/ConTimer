# CoN Timer Assistant 
A lightweight Chrome Extension designed for **Conflict of Nations** players to track unit movements, research, and city captures with integrated Discord notifications.

##  Features
- Set timers down to the second.
